...
fig.savefig('./image/raised_cosine.svg', bbox_inches='tight')
...
fig.savefig('./image/raised_cosine_freq.svg', bbox_inches='tight')
...
fig.savefig('./image/rrc_rolloff.svg', bbox_inches='tight')
