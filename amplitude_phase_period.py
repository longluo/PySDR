...
ax.annotate(text='', xy=(T / 4 + phi, 0), xytext=(T / 4 + phi, 1),
            arrowprops=dict(color='red', arrowstyle=arrowstyle))  # amplitude
...
fig.savefig('./image/amplitude_phase_period.svg', bbox_inches='tight')
